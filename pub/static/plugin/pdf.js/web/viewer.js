...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: '/r/plugin/pdf.js/web/debugger.js'
  };
}
...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require('/r/plugin/pdf.js/build/pdf.js');
}
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: sessionStorage.getItem('pdfToken'),
    kind: OptionKind.VIEWER
  },
  defaultZoomValue: {
    value: '',
  ...
  cMapUrl: {
    value: '/r/plugin/pdf.js/web/cmaps/',
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: '/r/plugin/pdf.js/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
